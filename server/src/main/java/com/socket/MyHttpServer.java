...
public class MyHttpServer {
        ...
        public static String WEB_ROOT = "D:/root";
        //端口
        private int port;
        //用户请求的文件的url
    ...
    //MyHttpServer运行之后, 在浏览器输入http://localhost:8080/post.txt
    //这里的路径是post.txt的存放路径
        public static void main(String args[]) throws Exception {
            MyHttpServer server = new MyHttpServer("C:\\Users\\admin\\IdeaProjects\\TestIdea\\src\\com\\httpsocket\\dome", 8080);
            server.service();
        }
}
