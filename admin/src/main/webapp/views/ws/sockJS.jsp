...
<%
    ...
    System.out.print("finalPath = " + finalPath);
%>
<html>
<head>
    <title>Hello WebSocket</title>
    <script src="${pageContext.request.contextPath}/recourse/js/jquery-1.7.2.min.js"></script>
    <script src="${pageContext.request.contextPath}/recourse/js/stomp.js"></script>
    <script src="${pageContext.request.contextPath}/recourse/js/sockjs.min.js"></script>
    <script type="text/javascript">
        ...
        function connect() {
            ...
            stompClient.connect({}, function (frame) {
                ...
                //系统订阅消息
                stompClient.subscribe('/userTest/queue/system/newMsg', function (greeting) {
                ...
                //新消息订阅
                stompClient.subscribe('/userTest/queue/chat/newMsg', function (greeting) {
                ...
                //访客消息响应订阅
                stompClient.subscribe('/userTest/queue/chat/msgResponse', function (greeting) {
                    alert("收到信息");
                });

                //关闭订阅消息
                stompClient.subscribe('/userTest/queue/system/close', function (greeting) {
...
<div>
    ...
    <div id="conversationDiv">
        <label>you can send message to WebSocketMessageController[ @MessageMapping("/sendMessage") ]</label><input
            type="text" id="name"/>
